(function (angular) {
    ...
    var thisModule = angular.module('pipFeedbackSamples', ['pipTranslate', 'pipCommonRest', 'pipFeedbackDialog']);
    ...
    thisModule.controller('pipFeedbackSamplesController',
        function ($scope, $mdDialog, $rootScope,  $state, pipFeedbackDialog) {
            ...
            function onFeedbackDialog(event) {
                pipFeedbackDialog.show({party: $rootScope.$party}, (answer) => {
                        if (answer) {
